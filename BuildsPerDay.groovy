...
// CONFIGURATION
// ***************************************************
def days = 9 // Ammount of days to report beginning from 'startingDate'. If 'startingDate' is not specified it reports the last number of days starting from today's date
